...
public class AIPlayer {
	...
	public static int distanceFromCenter(Marble m) {      //System.out.println(m.toString() + " " + Math.max(Math.abs(m.getAlpha() - 5), Math.abs(m.getNumeric() - 5)) );

...
public class AIPlayer {
    ...
    public static double evaluateBoard(Board b, boolean aiIsBlack){
        ...
        double ownMarbleVal = 30.0;
        double oppMarbleVal = 10.0;

        double centerMod = 20.0;
        double ring1Mod = 17.0;
        double ring2Mod = 15.0;
        double ring3Mod = 13.0;
        double ring4Mod = 8.0;

        int dist;
        double posMod = 0.0;

        double firstKO = 500.0;
        double secondKO = 500.0;
        double thirdKO = 600.0;
        double fourthKO = 750.0;
        double fifthKO = 800.0;
        ...
        if(oppMarbles == 13){ // at least one marble knocked out
            eval += firstKO;
        }
        if(oppMarbles == 12){ // at least two marbles knocked out
            eval += secondKO;
        }
        if(oppMarbles == 11){ // at least three marbles knocked out
            eval += thirdKO;
        }
        if(oppMarbles == 10){ // at least four marbles knocked out
            eval += fourthKO;
        }
        if(oppMarbles == 9){ // at least five marbles knocked out
            eval += fifthKO;
        }
        if(oppMarbles == 8){ // six marbles knocked out a.k.a. victory state
            eval += sixthKO;
        }
